  ...
  return (
    <div className="font-lato">
      ...
      <main className="flex justify-center">
        ...
        >
          <h2 className="font-medium">Registrarse</h2>
          <input
            {...register("email")}
          ...
          />
          <button
            className="w-[250px] m-3 text-center text-white rounded-[100px] h-[70px] transition ease-in-out delay-150 bg-blue-500 hover:-translate-y-1 hover:scale-110 hover:bg-indigo-500 duration-300"
            type="submit"
          >
            Enviar
          </button>
